...
class Simple(discord.ui.View):
    ...
    def __init__(
        ...
        *,
        timeout: int = 60,
        InitialButton: discord.ui.Button = discord.ui.Button(
            emoji=discord.PartialEmoji(name="\U000023ee")),
        ...
        LastButton: discord.ui.Button = discord.ui.Button(
            emoji=discord.PartialEmoji(name="\U000023ed")),
    ...
    async def start(self, ctx: discord.Interaction | commands.Context,
        ...
        self.message = await ctx.send(embed=self.pages[self.InitialPage],
                                      view=self,
    ...
    async def next_button_callback(self, interaction: discord.Interaction):
        if interaction.user != self.ctx.author:
            embed = discord.Embed(
                description="コマンドの実行者ではないためページ移動はできません",
